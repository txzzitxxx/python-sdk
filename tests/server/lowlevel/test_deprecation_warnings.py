# TODO: Decide whether we want deprecation warnings in another PR
# import warnings
#
# import pytest
#
...
#     request_with_cursor = ListPromptsRequest(method="prompts/list",
#       params=PaginatedRequestParams(cursor=cursor_value))
